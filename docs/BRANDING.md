...
- Release `v0.4.3` is the current GCP application release. The retained
  `v0.4.2` revision is the immediate application rollback reference; v0.4.1 and
  v0.4.0 revisions are also retained. Active application
...
All target identifiers remain active in release `v0.4.3`. The former service
