...
export default function AnalysisPage() {
  ...
  const [view, setView] = useState<AnalysisView>("trends");
  ...
  return (
    <section>
      ...
      <div className="data-tabs" role="tablist" aria-label="Analysis views">
        <TabButton active={view === "trends"} label="CTD Trends" onClick={() => setView("trends")} />
        <TabButton active={view === "correlations"} label="Correlations" onClick={() => setView("correlations")} />
        <TabButton active={view === "diversity"} label="Diversity" onClick={() => setView("diversity")} />
        <TabButton active={view === "cooccurrence"} label="Co-occurrence" onClick={() => setView("cooccurrence")} />
        <TabButton active={view === "reliability"} label="Reliability" onClick={() => setView("reliability")} />
      </div>

      <div className="section-toolbar">
        <span className="empty-state">{loading ? "Loading analysis artifacts." : "Analysis artifacts loaded."}</span>
